...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    <form action="${basePath}/seller/product/updateProduct" class="form-horizontal" method="post" >
                        ...
                        <div class="control-group"><label class="control-label">商品库存</label>
                            <div class="controls"><input id="productStock" name="productStock" type="text" value="${productInfo.productStock}" /></div>
                        </div>
                        <br>
                        ...
                        <div class="control-group"><label class="control-label">商品图片(输入地址)</label>
                            <div class="controls"><input id="productIcon" name="productIcon" type="text" value="${productInfo.productIcon}" /></div>
                        </div>
                        <br>
